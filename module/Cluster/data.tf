...
data "aws_iam_role_policy_attachment" "eks-cluster-policy" {
    name = var.cluste-policy-name
}

data "aws_iam_role_policy_attachment" "eks-VPCResourceController" {
    name = var.eks-vpc-resource-controller-name
}